...
const DepositHistory = () => {
  ...
  return (
    <div className="p-20 text-center relative font-serif bg-gray-100 min-h-screen">
      <h2 className="text-4xl mb-10 font-bold text-red-700">Deposit History</h2>
      ...
      <div className="flex justify-between items-center">
        <div className="flex font-bold text-sm cursor-pointer">
          ...
          <div className="mx-0.5 py-2.5 px-5 bg-yellow-400 rounded text-black text-center">Deposit</div>
          <div className="mx-0.5 py-2.5 px-5 bg-red-600 rounded text-white text-center hover:bg-red-700 transition" onClick={() => navigate('/deposite-history')}>Deposit History</div> 
        </div>
