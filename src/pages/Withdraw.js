...
const Withdraw = () => {
  ...
  const handleWithdraw = () => {
    const WithdrawData = { paymentMethod, amount, phoneNumber, date: new Date().toLocaleString() };
    const updatedHistory = [...WithdrawHistory, WithdrawData];
    ...
    <div className="p-10 md:p-20 text-center relative font-serif bg-gray-100 min-h-screen">
      ...
      <div className="flex justify-between items-center ">
        <div className="flex font-bold text-sm cursor-pointer space-x-1">
          ...
          <div className="py-2.5 px-5 bg-red-600 rounded text-white text-center hover:bg-red-700 transition" onClick={() => navigate('/withdraw-history')}>Withdraw History</div>
        </div>
      ...
      <table className="w-full border-collapse bg-white shadow-lg rounded">
        <thead>
          <tr className="">
            ...
            <th className="border-2 border-gray-400 p-2">GooglePay | PhonePay | Payment</th>
        ...
        <tbody>
          <tr>
            ...
            <td className="border-2 border-gray-400 ">
              <button className="bg-red-600 text-white px-4 py-1 rounded hover:bg-red-700 transition " onClick={handleWithdraw}>Withdraw</button>
            </td>
          </tr>
        </tbody>
      </table>
